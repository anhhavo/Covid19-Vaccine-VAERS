...
modernaSymptomsCountChild = load_data(5, 's3://cse427-finalproject/Results/modernaSymptomsCountChild.csv')
...
pfizerSymptomsCountChild = load_data(5, 's3://cse427-finalproject/Results/pfizerSymptomsCountChild.csv')
...
JANSSENSymptomsCountChild = load_data(5, 's3://cse427-finalproject/Results/JANSSENSymptomsCountChild.csv')
